    ...
    <AppBar position="static" sx={{ backgroundColor: '#be123c' }}>
      <Container maxWidth="xl">
        ...
        <Box component="img" src={image} alt="img" width="30px" height={"18px"} sx={{ marginRight: '60px' ,  display: { xs: 'none', md: 'flex' }, mr: 1  }} />
          ...
          <Box component="img" src={image} alt="img" width="20px" marginRight={"20px"} sx={{  display: { xs: 'block', sm: 'none' }, // xs ve sm boyutlarında göster, md ve daha büyük ekranlarda gizle
      mr: 1,
    }} />
          <Typography
            variant="h5"
